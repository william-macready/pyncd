...
| Dtypes beyond the admitted concrete `f64`/Float-backed-`bool` modes and dynamic shapes | Still rejected at the checked-plan preparation boundary (`f32` remains unsupported). |
