...
>   taking it as an argument. Pinned by `AdapterTest` fixture 22 (the review's probe for all three
...
>   same file. Pinned by `SignatureTest` fixture 13c (`#check_failure signatureOfDenseInputs`).
